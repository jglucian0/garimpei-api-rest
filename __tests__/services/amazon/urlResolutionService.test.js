...
describe('UrlResolutionService', () => {
  ...
  it('should follow redirection of short links like amzn.to and a.co', async () => {
    axios.get.mockResolvedValue({
      request: {
        res: {
          responseUrl: 'https://www.amazon.com.br/soundcore-Bluetooth-Resist%C3%AAncia-Microfones-Personaliz%C3%A1vel/dp/B0BTYCRJSS/ref=sr_1_1'
        }
      },
    ...
    expect(result).toBe('https://www.amazon.com.br/soundcore-Bluetooth-Resist%C3%AAncia-Microfones-Personaliz%C3%A1vel/dp/B0BTYCRJSS/ref=sr_1_1');
  });
});